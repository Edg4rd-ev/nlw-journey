...
export function Activities({ tripDetails }: Props) {
  ...
  const [isCreatingActivity, setIsCretingActivity] = useState(false)
  ...
  return (
    <View className="flex-1">
      ...
      <Modal
        ...
        subtitle="Selecionar a data de atividade"
